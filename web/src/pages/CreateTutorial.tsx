...
export const CreateTutorial: React.FC = () => {
    ...
    return (
        <div className="relative min-h-screen pt-24 pb-12 px-4 md:px-8 max-w-4xl mx-auto">
            <SEO title="Create Tutorial | BrainLabs" />
            ...
            >
                ...
                <div className="bg-card/60 backdrop-blur-md border border-border/50 rounded-3xl p-8 md:p-12 text-center shadow-xl">
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">Create New Tutorial</h1>
                    <p className="text-muted-foreground text-lg mb-8 max-w-lg mx-auto">
                        Share your knowledge with the community. Create an interactive or text-based tutorial on LLMs or Neuromorphic computing.
                    </p>
                    ...
                    <div className="w-full max-w-md mx-auto aspect-video rounded-2xl border border-dashed border-border bg-muted/30 flex items-center justify-center mb-8">
                        <span className="text-sm text-muted-foreground italic">Tutorial editor placeholder</span>
                    </div>
