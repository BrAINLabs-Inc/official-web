            ...
            <div className="overflow-hidden rounded-3xl border border-border/60 bg-card/60 shadow-lg backdrop-blur-sm">
              <div className="grid divide-y divide-border/40 lg:grid-cols-2 lg:divide-x lg:divide-y-0">
                ...
                >
                  ...
                  <div className="mb-6 space-y-3">
                    {channels.map(({ icon: Icon, label, value, href }) => (
                      ...
                      >
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-border/60 bg-card transition-all group-hover:border-primary/30 group-hover:bg-primary/5">
                          <Icon
                            size={18}
                            className="text-foreground/70 transition-colors group-hover:text-primary"
                          />
                        </div>
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-xs font-medium text-primary/80">{value}</p>
                        </div>
                      </a>
                    ))}
                  </div>
                  ...
                  {/* Map */}
                  <div className="mb-5 overflow-hidden rounded-2xl border border-border/50 bg-muted">
                    <iframe
                ...
                <motion.div
                  ...
                  className="bg-background/30 p-6 md:p-8"
                >
                  <div className="mb-6 flex items-center gap-3">
                    <div className="rounded-xl border border-primary/15 bg-primary/10 p-2">
