...
export const SEO = ({
  ...
  const defaultDescription =
    'BrAIN Labs - Braininspired AI and Neuroinformatics Lab. We explore the intersection of Artificial Intelligence, Machine Learning, and Neuroscience to develop innovative AI solutions.';
