...
export const CollaborationIcon = ({ size = 24, className = '' }: IconProps) => (
  ...
  >
    ...
    <path d="M3 13v1.5h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    {/* Right person */}
    <circle cx="19" cy="7" r="1.5" stroke="currentColor" strokeWidth="1.5" />
    <path d="M17 13v1.5h4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    {/* Connection lines */}
    <path
...
export const MissionCompassIcon = ({ size = 24, className = '' }: IconProps) => (
  ...
  >
    ...
    {/* Compass needle */}
    <path d="M12 5L10 12l2-1 2 1-2-7z" fill="currentColor" opacity="0.8" />
    <path d="M12 19l2-7-2 1-2-1 2 7z" fill="currentColor" opacity="0.4" />
    {/* Cardinal points */}
    <path
